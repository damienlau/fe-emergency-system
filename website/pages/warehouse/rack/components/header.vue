    ...
    <a-page-header
      ...
      <template #tags>
        <div class="tags">
          ...
          <div class="center">
            <p>
              箱子在库量：<span>{{ inStockNumFilter(rackCount.boxInStockNum)  }}</span>/{{ totalStockNumFilter(rackCount.boxInStockNum) }}
            </p>
            <p>
              物资在库量：<span>{{ inStockNumFilter(rackCount.materialInStockNum) }}</span>/{{ totalStockNumFilter(rackCount.materialInStockNum) }}
            </p>
          </div>
        </div>
      </template>
